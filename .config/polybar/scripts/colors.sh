...
# Replacing colors
sed -i -e 's/bg = .*/bg = #10dfdfdf/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #DFDFDF/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #f07178/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #dc344148/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #dc344148/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #292d3e/g' $PDIR/colors.ini
sed -i -e 's/mgf = .*/mgf = #292d3e/g' $PDIR/colors.ini
sed -i -e 's/mf = .*/mf = #89ddff/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH1 &
$LAUNCH2 &
