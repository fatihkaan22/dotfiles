...
translation_function_names = ['google', 'dict_cc']
...
extend_subs_duration_limit_sec = 2
...
mouse_buttons = [
	...
	['ScrollDown',		'ControlModifier',		'f_font_size_increase'],
	['ScrollUp',		'ControlModifier',		'f_font_size_decrease'],
